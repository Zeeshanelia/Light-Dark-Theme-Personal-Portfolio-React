export const Projects = () => {
  ...
  return (
    <section
      className={`
        relative w-full py-16 md:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden
          ...
          {projects.map((project, index) => {
            ...
            return (
              <div
                ...
                className={`
                  relative group
                  bg-white/65 dark:bg-gray-900/35 backdrop-blur-md
                  border border-gray-200/60 dark:border-gray-700/40
                  rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10
                  ...
                  <div className="flex flex-wrap gap-2.5 mb-6">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="
                          px-3.5 py-1.5 text-xs md:text-sm rounded-full
                  ...
                  >
                    ...
                    <span
                      className="
                        ...
                        group-hover/link:bg-emerald-500/20 dark:group-hover/link:bg-emerald-500/25
